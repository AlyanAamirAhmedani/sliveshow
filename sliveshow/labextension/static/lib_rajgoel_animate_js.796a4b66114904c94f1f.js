"use strict";
(self["webpackChunksliveshow"] = self["webpackChunksliveshow"] || []).push([["lib_rajgoel_animate_js"],{
...
const initAnimate = function (Reveal) {
    ...
    function setupAnimations(index, container, config) {
        ...
        animatedSVGs.push({
            svg: [...container.querySelectorAll('svg')].map(svg => (0,_svgdotjs_svg_js__WEBPACK_IMPORTED_MODULE_0__.SVG)(svg)),
        ...
        animatedSVGs[index].animation = new _svgdotjs_svg_js__WEBPACK_IMPORTED_MODULE_0__.Timeline().persist(true);
            ...
            for (var fragment = 0; fragment < animations.length; fragment++) {
                ...
                for (var i = 0; i < animations[fragment].length; i++) {
                    try {
                        ...
                        console.error('sliveshow: error setting up animation', animations[fragment][i], error);
                    }
                }
    ...
    function play() {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            try {
                (_b = (_a = animatedSVGs[index]) === null || _a === void 0 ? void 0 : _a.animation) === null || _b === void 0 ? void 0 : _b.play();
            }
            catch (error) {
    ...
    function pause() {
        ...
        for (var i = 0; i < elements.length; i++) {
            const index = elements[i].getAttribute('data-animation-index');
            try {
                (_b = (_a = animatedSVGs[index]) === null || _a === void 0 ? void 0 : _a.animation) === null || _b === void 0 ? void 0 : _b.pause();
            }
            catch (error) {
    ...
    function autoPause() {
        ...
        for (var i = 0; i < elements.length; i++) {
            const index = elements[i].getAttribute('data-animation-index');
            if (((_a = animatedSVGs[index]) === null || _a === void 0 ? void 0 : _a.animation) &&
                animatedSVGs[index].animationSchedule[fragment]) {
                ...
                var isLastFragment = fragment >= animatedSVGs[index].animationSchedule.length - 1;
    ...
    function loopRestart() {
        ...
        for (var i = 0; i < elements.length; i++) {
            const index = elements[i].getAttribute('data-animation-index');
            if (((_a = animatedSVGs[index]) === null || _a === void 0 ? void 0 : _a.animation) && animatedSVGs[index].loop) {
                animatedSVGs[index].animation.time(animatedSVGs[index].animationSchedule[0].begin || 0);
            }
        }
        play();
    }
    ...
    document.addEventListener('fullscreenchange', function (event) {
        ...
        for (var i = 0; i < elements.length; i++) {
            try {
                if (((_a = animatedSVGs[i]) === null || _a === void 0 ? void 0 : _a.animation) && animatedSVGs[i].animationSchedule) {
...
//# sourceMappingURL=lib_rajgoel_animate_js.796a4b66114904c94f1f.js.map