 ...
 */
const findSanitizedLeftover = (rendered) => {
    ...
    activate: (app, tracker, typesetter) => {
        ...
        const process = (cell, attempt = 0) => {
            ...
            try {
                ...
                const src = (_c = (_b = (_a = cell.model) === null || _a === void 0 ? void 0 : _a.sharedModel) === null || _b === void 0 ? void 0 : _b.getSource()) !== null && _c !== void 0 ? _c : '';
...
//# sourceMappingURL=lib_index_js-data_image_gif_base64_R0lGODlhIAAgAPMAAJmZmf_2F_2F_2F6_2Bvr8nJybW1tcDAwOjo6Nvb26-baaebe.1624cb8697d4d8b612aa.js.map